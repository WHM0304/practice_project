...
export default function initModels(sequelize) {
  ...
  tbl_fridge.belongsTo(tbl_product, { as: "FTOP", foreignKey: "f_pseq" });
  tbl_product.hasMany(tbl_fridge, { as: "PTOF", foreignKey: "f_pseq" });
  tbl_fridge.belongsTo(tbl_shopping, {
    as: "FTOS",
    foreignKey: "f_sseq",
  });
  tbl_shopping.hasMany(tbl_fridge, { as: "STOF", foreignKey: "f_sseq" });
